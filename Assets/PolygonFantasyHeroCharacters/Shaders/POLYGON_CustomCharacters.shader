...
Shader "SyntyStudios/CustomCharacter"
{
	Properties
	{
		...
		_Texture_Base_Secondary("Texture_Base_Secondary", 2D) = "white" {}
		_Texture_Metal_Secondary("Texture_Metal_Secondary", 2D) = "white" {}
		_Texture_Color_Metal_Dark("Texture_Color_Metal_Dark", 2D) = "white" {}
		_Texture_BodyArt("Texture_BodyArt", 2D) = "white" {}
